...
class RoleForm(ResourceForm):
    ...
    def update(self, data, files):
        self.update_nodes('PHASE_TYPE_ASSIGNMENT.E14', data)
        return
...
class PublicationForm(ResourceForm):
    ...
    def update(self, data, files):
        ...
        self.update_nodes('PLACE_OF_PUBLICATION.E53', data)
    ...
    def load(self, lang):
        if self.resource:
            ...
            self.data['PLACE_OF_PUBLICATION.E53'] = {
                'branch_lists': self.get_nodes('PLACE_OF_PUBLICATION.E53'),
                'domains': {
                }
            }
...
class ImageryForm(ResourceForm):
    ...
    def update(self, data, files):
        ...
        self.update_nodes('IMAGERY_PLACE_APPELLATION.E44', data)
        self.update_nodes('IMAGERY_SOURCE_TYPE.E55', data)
        self.update_nodes('RIGHT_TYPE.E55', data)
        self.update_nodes('RIGHT_DESCRIPTION.E30', data)
    ...
    def load(self, lang):
        if self.resource:
            ...
            self.data['IMAGERY_PLACE_APPELLATION.E44'] = {
                'branch_lists': self.get_nodes('IMAGERY_PLACE_APPELLATION.E44'),
                'domains': {
                }
            }
            ...
            self.data['RIGHT_DESCRIPTION.E30'] = {
                'branch_lists': self.get_nodes('RIGHT_DESCRIPTION.E30'),
                'domains': {
                }
...
class CartographyForm(ResourceForm):
    ...
    def load(self, lang):
        if self.resource:
            ...
            self.data['DATE_OF_FILE.E50'] = {
                'branch_lists': self.get_nodes('DATE_OF_FILE.E50'),
                'domains': {
                }
            }
            ...
            self.data['CREATOR_TYPE.E55'] = {
                'branch_lists': self.get_nodes('CREATOR_TYPE.E55'),
                'domains': {
